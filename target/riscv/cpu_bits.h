...
#define HVICONTROL_IID                     0x0fff0000
#define HVICONTROL_IID_SHIFT               16
#define HVICONTROL_IPRIOM                  0x00000100
#define HVICONTROL_IPRIOM_SHIFT            8
#define HVICONTROL_IPRIO                   0x000000ff
#define HVICONTROL_VALID_MASK              \
    (HVICONTROL_VTI | HVICONTROL_IID | HVICONTROL_IPRIOM | HVICONTROL_IPRIO)
